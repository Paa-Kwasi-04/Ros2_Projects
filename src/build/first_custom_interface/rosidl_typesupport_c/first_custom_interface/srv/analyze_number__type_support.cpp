...
static const _AnalyzeNumber_Request_type_support_symbol_names_t _AnalyzeNumber_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, first_custom_interface, srv, AnalyzeNumber_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, first_custom_interface, srv, AnalyzeNumber_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, first_custom_interface, srv, AnalyzeNumber_Request)() {
  return &::first_custom_interface::srv::rosidl_typesupport_c::AnalyzeNumber_Request_message_type_support_handle;
}
...
static const _AnalyzeNumber_Response_type_support_symbol_names_t _AnalyzeNumber_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, first_custom_interface, srv, AnalyzeNumber_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, first_custom_interface, srv, AnalyzeNumber_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, first_custom_interface, srv, AnalyzeNumber_Response)() {
  return &::first_custom_interface::srv::rosidl_typesupport_c::AnalyzeNumber_Response_message_type_support_handle;
}
...
static const _AnalyzeNumber_type_support_symbol_names_t _AnalyzeNumber_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, first_custom_interface, srv, AnalyzeNumber)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, first_custom_interface, srv, AnalyzeNumber)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, first_custom_interface, srv, AnalyzeNumber)() {
  return &::first_custom_interface::srv::rosidl_typesupport_c::AnalyzeNumber_service_type_support_handle;
}
