...
class Metaclass_AnalyzeNumber(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'first_custom_interface.srv.AnalyzeNumber')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from first_custom_interface.srv import _analyze_number
...
class AnalyzeNumber(metaclass=Metaclass_AnalyzeNumber):
    from first_custom_interface.srv._analyze_number import AnalyzeNumber_Request as Request
    from first_custom_interface.srv._analyze_number import AnalyzeNumber_Response as Response
