...
#ifndef FIRST_CUSTOM_INTERFACE__SRV__DETAIL__ANALYZE_NUMBER__FUNCTIONS_H_
#define FIRST_CUSTOM_INTERFACE__SRV__DETAIL__ANALYZE_NUMBER__FUNCTIONS_H_
 ...
 * calls
 * first_custom_interface__srv__AnalyzeNumber_Request__init().
...
/**
 * It calls
 * first_custom_interface__srv__AnalyzeNumber_Request__fini()
 ...
 * first_custom_interface__srv__AnalyzeNumber_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * first_custom_interface__srv__AnalyzeNumber_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * first_custom_interface__srv__AnalyzeNumber_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_first_custom_interface
...
/**
 * It calls
 * first_custom_interface__srv__AnalyzeNumber_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_first_custom_interface
...
/**
 * It allocates the memory for the array and calls
 * first_custom_interface__srv__AnalyzeNumber_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_first_custom_interface
...
/**
 * It calls
 * first_custom_interface__srv__AnalyzeNumber_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FIRST_CUSTOM_INTERFACE__SRV__DETAIL__ANALYZE_NUMBER__FUNCTIONS_H_
