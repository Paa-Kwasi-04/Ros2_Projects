...
#ifndef FIRST_CUSTOM_INTERFACE__SRV__DETAIL__RETURN_TO_BASE__FUNCTIONS_H_
#define FIRST_CUSTOM_INTERFACE__SRV__DETAIL__RETURN_TO_BASE__FUNCTIONS_H_
...
#include "first_custom_interface/msg/rosidl_generator_c__visibility_control.h"

#include "first_custom_interface/srv/detail/return_to_base__struct.h"

/// Initialize srv/ReturnToBase message.
/**
...
/// Create srv/ReturnToBase message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * first_custom_interface__srv__ReturnToBase_Request__init().
...
/// Destroy srv/ReturnToBase message.
/**
 * It calls
 * first_custom_interface__srv__ReturnToBase_Request__fini()
...
/// Check for srv/ReturnToBase message equality.
/**
...
/// Copy a srv/ReturnToBase message.
/**
...
/// Initialize array of srv/ReturnToBase messages.
/**
...
/// Finalize array of srv/ReturnToBase messages.
/**
 * It calls
 * first_custom_interface__srv__ReturnToBase_Request__fini()
...
/// Create array of srv/ReturnToBase messages.
/**
 * It allocates the memory for the array and calls
 * first_custom_interface__srv__ReturnToBase_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ReturnToBase messages.
/**
 * It calls
 * first_custom_interface__srv__ReturnToBase_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ReturnToBase message array equality.
/**
...
/// Copy an array of srv/ReturnToBase messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * first_custom_interface__srv__ReturnToBase_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_first_custom_interface
...
/**
 * It calls
 * first_custom_interface__srv__ReturnToBase_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_first_custom_interface
...
/**
 * It allocates the memory for the array and calls
 * first_custom_interface__srv__ReturnToBase_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_first_custom_interface
...
/**
 * It calls
 * first_custom_interface__srv__ReturnToBase_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FIRST_CUSTOM_INTERFACE__SRV__DETAIL__RETURN_TO_BASE__FUNCTIONS_H_
