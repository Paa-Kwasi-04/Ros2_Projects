...
bool firt_custom_interface__srv__analyze_number__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("firt_custom_interface.srv._analyze_number.AnalyzeNumber_Request", full_classname_dest, 63) == 0);
  }
  firt_custom_interface__srv__AnalyzeNumber_Request * ros_message = _ros_message;
  {  // number
...
PyObject * firt_custom_interface__srv__analyze_number__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("firt_custom_interface.srv._analyze_number");
...
ROSIDL_GENERATOR_C_EXPORT
bool firt_custom_interface__srv__analyze_number__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("firt_custom_interface.srv._analyze_number.AnalyzeNumber_Response", full_classname_dest, 64) == 0);
  }
  firt_custom_interface__srv__AnalyzeNumber_Response * ros_message = _ros_message;
  {  // parity
